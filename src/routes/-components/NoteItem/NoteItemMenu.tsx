...
export function NoteItemMenu({
  ...
  return (
    <div
      ...
      role="menu"
    >
      <button className="q-note-item__menu-item" role="menuitem" onClick={onRename}>
        <Edit3 size={13} strokeWidth={1.75} />
        Rename
      </button>
      <button className="q-note-item__menu-item" role="menuitem" onClick={onManageTags}>
        <Tag size={13} strokeWidth={1.75} />
        Manage Tags
      </button>
      <div className="q-note-item__menu-divider" />
      <button
        className={cn('q-note-item__menu-item', 'q-note-item__menu-item--danger')}
        role="menuitem"
        onClick={onDelete}
      >
